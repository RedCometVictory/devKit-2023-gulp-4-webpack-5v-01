...
// const sass = require("gulp-sass"); // --- original
// updated version, can be (require("sass")) or (require("node-sass"))
const sass = require("gulp-sass")(require("sass"));
const autoprefixer = require("gulp-autoprefixer");
// * keep version to 7.1.0
...
// * place into package.json if using ESM (ECMAScript Modules) -> "type": "module",
